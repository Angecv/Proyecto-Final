...
# Mapa final
    ...
    registros_presencia["popup"] = registros_presencia["species"] + " " + registros_presencia["stateProvince"]+ " " + registros_presencia["locality"]
    # Capa de Provincias
    folium.GeoJson(data=cantones, name='Cantones').add_to(m)
